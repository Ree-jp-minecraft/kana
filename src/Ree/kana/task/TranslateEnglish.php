...
class TranslateEnglish extends AsyncTask
{
	...
	{
		$url = 'https://script.google.com/macros/s/AKfycbz00c97OofTCTZ0WU3s4b5vQG__GtD2CVPVgT6mnMzRRPb-qJ9k/exec?text='.rawurlencode(str_replace(' ', '', $this->text)).'&source=ja&target=en';
